...
build: vectorAdd_MultiGPU

vectorAdd_MultiGPU.o: vectorAdd_MultiGPU.cu
	$(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

vectorAdd_MultiGPU: vectorAdd_MultiGPU.o
...
clean:
	rm -f vectorAdd_MultiGPU vectorAdd_MultiGPU.o 
	rm -rf ../../bin/$(OS_ARCH)/$(OSLOWER)/$(TARGET)$(if $(abi),/$(abi))/vectorAdd_MultiGPU
